...
class mytest(unittest.TestCase):
    ...
    def test_removenode(self):
        ...
        self.assertEqual(self.graph.get_mc(), 10)       # i dont count the mc fo remove edge like you asked
    ...
    def test_mc(self):
        ...
        self.assertTrue(self.graph.add_edge(1, 0, 45))
        self.assertTrue(self.graph.add_edge(2, 0, 45))
        self.assertTrue(self.graph.add_edge(1, 4, 45))
        self.assertTrue(self.graph.add_edge(3, 7, 45))
        self.assertEqual(self.graph.e_size(), 6)
        self.assertEqual(self.graph.get_mc(),16)
        self.graph.remove_node(0)
        self.assertEqual(self.graph.get_mc(), 17)
